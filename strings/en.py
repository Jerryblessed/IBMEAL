...
conversation_after_start = "Hello!\n" \
                           "Welcome to IBTROS Meal NG 🇳🇬!\n" \
                           "Here you can order 🍞 <b>Delicious meal</b> and get it in matter of minutes at to your destination.\n" \
                           "All by chatting with the conversational <b> AI </b>.\n" \
...
conversation_open_admin_menu = "\U0001F44B Welcome to IBMEAL NG, \U0001F372\n" \
                               "\n" \
...
conversation_cart_actions = "<i>order for meal(s) by scrolling up and pressing the book button below" \
                            " the meal you want to book. When you're done, go back to this message and" \
...
# Menu: add to cart
menu_add_to_cart = "➕ book plate(s)/pack(s)"
...
meal_type = (
    "👋 Hey there! Feeling hungry? 🍽️\n"
    "We currently serve only Abuja and Lagos. 🌍\n\n"
    "What Nigerian dish do you prefer today? 😋\n\n"
    "You can <b>one at a time from a variety</b> of some delicious meals offered:\n\n"
    ...
    "🍲 <b>Porridges & Yam, Plaintain and potato Dishes</b>\n"
    "🍛 Beans- ₦3,000\n"
    "🍳 Boiled Yam - ₦3,000\n"
    "🍟 Fried Yam - ₦1,500\n"
    "🔥 Yam Porridge (Asaro) - ₦3,500\n"
    ...
    "🍳 Boiled Plaintain - ₦3,000\n"
    "🍟 Fried Plaintain - ₦3,000\n\n"    
    ...
    "<i>Send your meal choice, press the Skip button below if you need more time to decide or press the 4-square icon for other options.</i>"
)
...
error_no_worker_for_chat = "🍽️ Looks like your session is on hold!\n" \
                           "To get things sizzling again, just type <b>/start</b> and we’ll serve up the conversation right where we left off. Bon appétit! 🍔🔥"
